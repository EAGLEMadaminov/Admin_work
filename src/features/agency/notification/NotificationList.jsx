    ...
    <div className="">
      {data.map((item) => {
        return (
          <div
            key={item.id}
            className="flex my-5 w-full justify-between bg-white rounded-lg ml-4 p-5"
          >
            <div className="flex justify-between w-[100%] items-end">
              <div className="flex">
                ...
                <div className="ml-2 flex flex-col py-3 justify-between">
                  <div>
                    <p className="text-[#6941C6] text-[14px] font-semibold">
                      {item.description}
                    </p>
                    <h2 className="text-[#101828] text-[18px] font-[500]">
                      {item.title}
                    </h2>
                    <p className="mt-3 font-semibold text-[#603DB6]">
                      {" "}
                      Abdulaziz abduqahhorov <span>+9989012345567</span>
                    </p>
                  </div>
